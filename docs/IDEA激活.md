...
### 1.下载激活插件
[点击下载](https://github.com/weiluoliang/memorandum/releases/download/0.2/jetbra.zip)

### 2.执行激活命令

执行之前，请关闭你的IDEA，避免不必要的麻烦

解压下载的插件安装包 ，如我的目录是： `C:\dev\jetbra\scripts`

```
如果你是mac用户，请执行  ${path}/jetbra/scripts/install.sh
如果你是windows用户，请执行  ${path}/jetbra/scripts/install-current-user.vbs
```
...
![image-20240411173249855](../img/IDEA激活/image-20240411173249855.png)

![image-20240411173433184](../img/IDEA激活/image-20240411173433184.png)

### 3.打开你的IDEA，执行输入激活码

![image-20240411173626648](../img/IDEA激活/image-20240411173626648.png)
